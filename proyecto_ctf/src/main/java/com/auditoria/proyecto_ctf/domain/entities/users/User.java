package com.auditoria.proyecto_ctf.domain.entities.users;
...
public class User {
    ...
    public Timestamp getCreaterdAt() {
        return createrdAt;
    }

    public void setCreaterdAt(Timestamp createrdAt) {
        this.createrdAt = createrdAt;
    }
